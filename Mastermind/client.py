...
class MastermindClient:
    def __init__(self, master):
        self.master = master
        self.master.title("Mastermind Client 1")
    ...
    def connect_to_server(self):
        ...
        self.server_connection.connect(('localhost', 5555))
        threading.Thread(target=self.ricevi_risposta, daemon=True).start()

    def create_widgets(self):
        title_label = tk.Label(self.master, text="Mastermind Client 1", font=("Helvetica", 24, "bold"), pady=10)
        title_label.pack()
